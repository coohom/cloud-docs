# DSL Sample Code
This example simulates a sweeping robot traveling in a room with a bow-shaped trajectory at a fixed rate, and it takes 15 sets of pictures per second 
```python
    ...
    def process(self):
        ...
        for room in self.shader.world.rooms:
            ...
            camera = self.shader.world.create_camera(
                ...
                # Set camera position
                position={'x':room_center_x, 'y':room_center_y, 'z':70},
